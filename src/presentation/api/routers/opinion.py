...
from src.application.agents.claim_atomizer.agent import AtomicClaim
from src.application.agents.web_opinion_extractor import WebOpinionAnalyzer, WebOpinionEngine
...
from ..schemas import (
    ...
    _convert_atomic_opinion, _convert_bias_distribution, ClaimComparisonResult
)
...
async def analyze_url_complete(
    ...
    - MBFC prior: Optional persistence lookup for bias prior
...
async def get_overall_bias_score(
    ...
    Uses WebOpinionEngine with MBFC support.
