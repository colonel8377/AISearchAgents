...
from src.application.few_shots.conflict_auditor.few_shots import CONFLICT_AUDITOR_FEW_SHOTS
from src.infrastructure.factory.vector_store import VectorStoreFacade
    ...
    def __init__(
        ...
        if settings.enable_persistence:
            try:
                ...
                self._custom_few_shots = database.load_custom_few_shots("conflict_auditor")
...
"""
    ...
    def compare_claims(
        ...
        if use_embedding_similarity and summary_claims and url_claims:
            try:
                embeddings = VectorStoreFacade.create_embeddings()
